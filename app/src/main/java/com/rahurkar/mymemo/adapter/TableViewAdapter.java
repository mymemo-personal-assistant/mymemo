...
public class TableViewAdapter extends AbstractTableAdapter<String, String, Cell> {
    ...
    public AbstractViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        // Get cell xml layout
        Log.d(TAG, "onCreateCellViewHolder: Started");
    ...
    public void onBindColumnHeaderViewHolder(AbstractViewHolder holder, Object columnHeaderItemModel, int
            position) {
        String day = (String) columnHeaderItemModel;
        Log.d(TAG, "onBindColumnHeaderViewHolder: position : " + day);
        // Get the holder to update cell item text
        MyColumnHeaderViewHolder columnHeaderViewHolder = (MyColumnHeaderViewHolder) holder;
        columnHeaderViewHolder.cell_textview.setText(day);
    ...
    public void onBindRowHeaderViewHolder(AbstractViewHolder holder, Object rowHeaderItemModel, int
            position) {
        String time = (String) rowHeaderItemModel;


        // Get the holder to update row header item text
        MyRowHeaderViewHolder rowHeaderViewHolder = (MyRowHeaderViewHolder) holder;
        rowHeaderViewHolder.cell_textview.setText(time);
    }
